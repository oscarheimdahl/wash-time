...
export function addBooking(newBooking: LaundryBooking, supabase?: SupabaseType) {
	if (supabase) insertDBBooking(supabase, newBooking.user, newBooking.date, newBooking.part);
...
export function deleteBooking(booking: LaundryBooking, supabase?: SupabaseType) {
	if (supabase) deleteDBBooking(supabase, booking.user, booking.date, booking.part);
